...
class TestRetrievalQuality:
    ...
    def test_should_meet_precision_threshold_on_single_hop(
        self, single_hop_queries, eval_thresholds
    ):
        ...
        assert avg_precision >= threshold, (
            f"Precision@4 = {avg_precision:.3f} 低于阻断阈值 {threshold}"
        )

    def test_should_meet_recall_threshold_on_single_hop(
        self, single_hop_queries, eval_thresholds
    ):
        ...
        assert avg_recall >= threshold, (
            f"Recall@4 = {avg_recall:.3f} 低于阻断阈值 {threshold}"
        )
    ...
    def test_edge_case_queries_should_return_empty_or_low_scores(
